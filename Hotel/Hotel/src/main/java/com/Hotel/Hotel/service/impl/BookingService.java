...
public class BookingService implements IBookingService {
    ...
    public Response saveBooking(Long roomId, Long userId, Booking bookingRequest) {
        ...
        try {
            ...
            Room room = roomRepository.findById(roomId).orElseThrow(() -> new OurException("Habitacion no encontrada"));
    ...
    public Response findBookingByConfirmationCode(String confirmationCode) {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error al encontrar  reserva: " + e.getMessage());
    ...
    public Response cancelBooking(Long bookingId) {
        ...
        try {
            bookingRepository.findById(bookingId).orElseThrow(() -> new OurException("La reserva no existe"));
