...
public class UserService implements IUserService {
    ...
    public Response register(User user) {
        ...
        try {
            ...
            response.setMessage(" Error ocurrido durante el registro del usuario " + e.getMessage());
    ...
    public Response login(LoginRequest loginRequest) {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Se produjo un error durante el inicio de sesión del usuario " + e.getMessage());
        }
        return response;
    }
    ...
    public Response getAllUsers() {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error al obtener todos los usuarioss " + e.getMessage());
        }
        return response;
    }
