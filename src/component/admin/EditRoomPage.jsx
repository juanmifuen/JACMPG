...
const EditRoomPage = () => {
    ...
    const handleUpdate = async () => {
        try {
            ...
            if (result.statusCode === 200) {
                setSuccess('Habitación actualizada con éxito.');
    ...
    const handleDelete = async () => {
        if (window.confirm('¿Quieres eliminar esta Habitacion?')) {
            try {
    ...
    return (
        <div className="edit-room-container">
            ...
            <div className="edit-room-form">
                ...
                <div className="form-group">
                    <label>Habitacion Descripcion</label>
                    <textarea
                ...
                <button className="update-button" onClick={handleUpdate}>Cargar Habitacion</button>
                <button className="delete-button" onClick={handleDelete}>Eliminar Habitacion </button>
            </div>
        </div>
    );
};
