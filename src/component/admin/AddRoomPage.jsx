...
const AddRoomPage = () => {
    ...
    const addRoom = async () => {
        ...
        if (!window.confirm('¿Quieres añadir  habitación?')) {
            return
        }
        ...
        try {
            ...
            if (result.statusCode === 200) {
                setSuccess('Habitación añadida con éxito.');
            ...
            <div className="edit-room-form">
                ...
                <div className="form-group">
                    ...
                    <select value={roomDetails.roomType} onChange={handleRoomTypeChange}>
                        ...
                        <option value="new">otro (por favor especifica)</option>
                    </select>
                    {newRoomType && (
                        <input
                            type="text"
                ...
                <div className="form-group">
                    <label>Descripcion Habitacion </label>
                    <textarea
                ...
                <button className="update-button" onClick={addRoom}>Añadir Habitacion</button>
            </div>
        </div>
    );
};
